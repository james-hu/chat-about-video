...
| `Optional` **frameDirectoryResolver**: (`inputFile`: `string`, `tmpDir`: `string`, `conversationId`: `string`) => `string` | Function for determining the directory location for storing extracted frames.<br>If not specified, a default function will be used.<br>The function takes three arguments:                                                              |
